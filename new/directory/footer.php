...
if($_GET['page_id']==46){
 ?>
<article id="inner-services_wrapper">
	<section class="container">
			...
			<figcaption class="events_photos">
				<h4>FON Events Photos / Videos</h4>
					<img src="images/239x164.png">
				<img src="images/377x164.png">
				<img src="images/377x164.png">
				<img src="images/239x164.png">
			</figcaption>
...
<footer id="footer-wrapper">
	<section class="container">
		...
		<nav class="service">
			...
			<li><a href="http://pbfoa.org/directory/?page_id=63">List Your Company</a></li>
		</nav>
		...
		<section class="footer-bottom">
			<figure class="footer-logo">
				<img src="http://pbfoa.org/images/pbfoa-footer-logo.jpg" alt="Pbfoa logo" />
				<a href="http://www.familyofficenetworks.com" target="_blank"><img src="http://pbfoa.org/images/fon-footer-logo.jpg" alt="FON logo" />
			</figure>
			<figure class="copyright">
				<figcaption>
					<a href="https://www.facebook.com/FamilyOfficeNetworks" target="_blank"><img src="http://pbfoa.org/images/facebook.jpg" alt="icon" /></a>
					<a href="https://www.linkedin.com/company/the-family-office-networks" target="_blank"><img src="http://pbfoa.org/images/linkedin.jpg" alt="icon" /></a>
					<a href="https://twitter.com/FamilyOfficeNet" target="_blank"><img src="http://pbfoa.org/images/twitter.jpg" alt="icon" /></a>
					<a href="#"><img src="http://pbfoa.org/images/googleplus.jpg" alt="icon" /></a>
				</figcaption>
				<figcaption>
