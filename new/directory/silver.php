<?php
$pagetitle_custom = "Featured Membership";
	include('header.php');
...
<option value="Zimbabwe">Zimbabwe</option>
			...
			<label class="full">Company Bio (* text only, no html codes) - limited to 750 characters. <span class="char_limit"></span><br />
			
			<textarea id="textarea" name="company_bio" placeholder="Company bio goes here..." maxlength="750" required></textarea>
