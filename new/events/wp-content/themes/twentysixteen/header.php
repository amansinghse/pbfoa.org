			...
			<script src="http://pbfoa.org/js/jquery-1.9.1.min.js"></script>
				...
				<nav class="main_nav">	
					<ul id="menu-panel">
						...
						<li><a href="http://pbfoa.org/events/events/">Events</a>
							<ul>
								<li><a href="http://pbfoa.org/events/events/">Event Calender</a></li>
								<li><a href="http://pbfoa.org/page.php?page_id=147">Current Events</a></li>
								<li><a href="http://pbfoa.org/events/event-photos-videos/">Event Photos & Videos</a></li>
						...
						<li><a href="http://pbfoa.org/page.php?page_id=143">News</a>
							<ul>
								<li><a href="http://pbfoa.org/page.php?page_id=143">Our  FON Newsletter</a></li>
						...
						<li><a href="http://pbfoa.org/page.php?page_id=42">Contact</a></li>						
					</ul>	
				</nav>
			</section>
			<script>
