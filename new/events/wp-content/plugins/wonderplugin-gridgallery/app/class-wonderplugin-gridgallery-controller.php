...
class WonderPlugin_Gridgallery_Controller {
	...
	function init() {
		...
		$engine = array("WordPress Portfolio Plugin", "WordPress Portfolio", "WordPress Portfolio Gallery", "WordPress Portfolio Gallery Plugin", "Responsive WordPress Portfolio Plugin", "Responsive WordPress Portfolio", "Responsive WordPress Portfolio Gallery", "Responsive WordPress Portfolio Gallery Plugin");
