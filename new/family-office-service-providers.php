...
$_SESSION['data'] = "
		...
		<th>Sponsoring events : </th><td>".$_POST["sponsoringevents"]."</td></tr><tr>
		<th>Interest: U.S Cities  : </th><td>". @join(", ", $_REQUEST["uscities"]) ."</td></tr><tr>
		<th>Other Cities  : </th><td>".$_POST["othercity"]."</td></tr><tr>
		<th>Global : </th><td>". @join(", ", $_REQUEST["global"]) ."</td></tr><tr>
		<th>Service provider directory :  </th><td>".$_POST["spdire"]."</td></tr><tr>
...
$mail->addAddress('naeem.pixector@gmail.com', 'Andrew');
$mail->Subject = 'Services Provider Membership';
...
<script>
            function send() {
				...
				var sponsoringevents = document.getElementsByName("sponsoringevents");
                if (! sponsoringevents[0].checked == false) {
                } else if (! sponsoringevents[1].checked == false) {
                } else {
                    alert("You must select Are you intrested in sponsoring events?");
                    return false;
                } 
				
                var spdire = document.getElementsByName("spdire");
                if (! spdire[0].checked == false) {
                } else if (! spdire[1].checked == false) {
                } else {
                    alert("You must select FON’s service provider directory?");
                    return false;
                }
...
<article id="inner-page-wrapper">
	...
	<ul class="personal-reg">
		...
		<li><input type="text" value="" placeholder="Job Title:" onfocus="this.placeholder = ''" onblur="this.placeholder = 'Job Title:'" name="job" required/></li>
...
<option value="Zimbabwe">Zimbabwe</option>
	...
	<ul class="radiobuttonreg">
		...
		<li><input type="radio" name="sponsoringevents" value="Yes">Yes</li>
		<li><input type="radio" name="sponsoringevents" value="No">No</li>
		
		</ul>	
		<h5>Other Locations of Intrest: U.S Cities</h5>
		<li><input type="checkbox" name="uscities[]" value="New York City">New York City</li>
		<li><input type="checkbox" name="uscities[]" value="London">London</li>
		<li><input type="checkbox" name="uscities[]" value="China">China</li>
		<li><input type="checkbox" name="uscities[]" value="Hongkong">Hongkong</li>
		<li><input type="checkbox" name="uscities[]" value="Canada">Canada</li>
		<li><input type="checkbox" name="uscities[]" value="Brazil">Brazil</li>
		<li><input type="checkbox" name="uscities[]" value="London">London</li>
		<li><input type="checkbox" name="uscities[]" value="Chicago">Chicago</li>
		<li><input type="checkbox" name="uscities[]" value="Boston">Boston</li>
		<li><input type="checkbox" name="uscities[]" value="Houston">Houston</li>
		<li><input type="checkbox" name="uscities[]" value="Palm Beach">Palm Beach</li>
		<li><input type="checkbox" name="uscities[]" value="San Francisco">San Francisco</li>
		<li><input type="checkbox" name="uscities[]" value="Dallas">Dallas</li>
		<li><input type="checkbox" name="uscities[]" value="Atlanta">Atlanta</li>
		<li><input type="checkbox" name="uscities[]" value="Naples">Naples</li>
		<li><input type="checkbox" name="uscities[]" value="San Diego">San Diego</li>
		<li><input type="checkbox" name="uscities[]" value="Miami">Miami</li>
		<li><input type="checkbox" name="uscities[]" value="Tampa Bay">Tampa Bay</li>
		<li><input type="checkbox" name="uscities[]" value="Connecticut">Connecticut</li>
		<li><input type="checkbox" name="uscities[]" value="Denver">Denver</li>
		<li><input type="checkbox" name="global[]" value="Singapore">Singapore</li>
		<li><input type="checkbox" name="global[]" value="Washington DC">Singapore</li>
		<li><input type="checkbox" name="uscities[]" value="Other" id="otherbox">Other<span><input type="text"name="othercity" id="extrafied" placeholder="If other please Explain" /></span></li>
		...
		<h5>Global</h5>
		<li><input type="checkbox" name="global[]" value="Australia">Australia</li>
		<li><input type="checkbox" name="global[]" value="Latin America">Latin America</li>
		<li><input type="checkbox" name="global[]" value="Eastern Europe">Eastern Europe</li>
		<li><input type="checkbox" name="global[]" value="Middle East">Middle East</li>
		<li><input type="checkbox" name="global[]" value="Australia">Hong Kong</li>
		<li><input type="checkbox" name="global[]" value="China">China</li>
		<li><input type="checkbox" name="global[]" value="Canada">Canada</li>
		<li><input type="checkbox" name="global[]" value="Brazil">Brazil</li>
		<li><input type="checkbox" name="global[]" value="Switzerland">Switzerland</li>
		<li><input type="checkbox" name="global[]" value="Singapore">Singapore</li>
		<li><input type="checkbox" name="global[]" value="London">London </li>
		
		<ul class="radiobuttonreg">
		<h5>Would you like your firm to be listed in FON’s service provider directory? </h5>
		
<li><input type="radio" name="spdire" value="Yes">Yes</li>
		<li><input type="radio" name="spdire" value="No">No</li>
		...
		<input type="Submit" value="NEXT" class="red-btn" name="submit_membership"/>
	</form>
