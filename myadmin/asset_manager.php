...
if($_REQUEST['action']=="delete"){
		$query="delete from asset_manager where id='".$_REQUEST['id']."'";
...
<!-- header section-->
	...
	<!--menu section--> 
		...
		<div class="col-md-10">
			...
			<h1 style="float: left; width: 100%; margin-top: 15px;">List of Asset Manager 
			...
			<a href="?action=add" style="color: #0064bb; text-decoration: none; font-size: 14px; border: 1px solid; padding: 7px 20px;" class="xport">Add Membership</a>
			 ...
			 <a href="asset_export.php" style="color: #0064bb; text-decoration: none; font-size: 14px; border: 1px solid; padding: 7px 20px;" class="xport">Export Data</a>
			...
			<a  href="asset_manager.php" style="color: #0064bb; text-decoration: none; font-size: 14px; border: 1px solid; padding: 7px 20px;" class="xport">List Data</a>
			...
			<?php require_once("message.php");
				if($_REQUEST['action']=="edit"){
					$query="select * from asset_manager WHERE id=".$_REQUEST['id'];
			   ...
			   <tr>
				  ...
				  <td>  <input type="submit" value="Add Member" name="addition" class="btn btn-primary"  /></td>
				</tr>
			  </table>
					</form>
				<?php
					...
					<tr>
						...
						<td>
							...
							<?php 
									...
									function writeMsg() {
											$d= $data[0]['i'];
										echo '<script>window.location.href = "asset_manager.php?action=view&id="'.$d.'"";</script>';
			...
			<div class="col-md-12 ">
			 <table id="example1" class="table  table-bordered table-striped">
					...
					$query="select * from asset_manager order by id";
			...
			$k = 1;
				...
				<tr>
					...
					<td><a  href="?action=edit&id=<?php echo $row['id'];?>"><?php echo $row['lname'];?></a></td>        
