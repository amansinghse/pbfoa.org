...
define('NICUPLOAD_PATH',UPLOAD_PATH_ORG); // Set the path (relative or absolute) to

                                      // the directory to save image files

                                      

define('NICUPLOAD_URI',UPLOAD_URL_ORG);   // Set the URL (relative or absolute) to
...
function nicupload_output($status, $showLoadingMsg = false) {
	...
	//$script = (($_SERVER['REQUEST_METHOD']=='POST') ? 'parent.' : '').'nicUploadButton.statusCb('.json_encode($status).')';
