...
if($_REQUEST['action']=="delete"){
		$query="delete from other_membership where id='".$_REQUEST['id']."'";
...
country,company_des,notes,Date,Createdby)
 VALUES ('$fname','$email','$phone','$company','$address','$city',
 '$state','$zip','$country','$company_des','$notes','$date','$createdby')";
...
$q="INSERT INTO other_membership (fname,email,phone,company,address,city,state,zip,country,company_des,notes,Date)
...
<!-- header section-->
	...
	<!--menu section--> 
		...
		<div class="col-md-10">
			...
			<h1 style="float: left; width: 100%; margin-top: 15px;">List of Other Membership
			 ...
			 <a href="other_export.php" style="color: #0064bb; text-decoration: none; font-size: 14px; border: 1px solid; padding: 7px 20px;" class="xport">Export Data</a>
			...
			<a  href="other_membership.php" style="color: #0064bb; text-decoration: none; font-size: 14px; border: 1px solid; padding: 7px 20px;" class="xport">List Data</a>
			...
			if($_REQUEST['action']=="edit"){
					$query="select * from other_membership WHERE id=".$_REQUEST['id'];
			   ...
			   <tr>
				  <td width="20%">&nbsp;</td>
				  <td >
					<input type="submit" value="Add Membership" class="btn btn-primary" name="addition" /></td>
				</tr>
			  </table>
					</form>
				<?php
				...
				<tr>
						...
						<td>
							...
							<?php 
									...
									function writeMsg() {
											$d= $data[0]['i'];
										echo '<script>window.location.href = "other_membership.php?action=view&id="'.$d.'"";</script>';
			...
			<div class="col-md-12 ">
			 <table id="example1" class="table  table-bordered table-striped">
					...
					$query="select * from other_membership order by id";
			...
			$k = 1;
				...
				<tr>
					...
					<td><?php echo $k;?></td>
					<td><a  href="?action=edit&id=<?php echo $row['id'];?>"><?php echo $row['fname'];?></a></td>            
					<td><a  href="?action=edit&id=<?php echo $row['id'];?>"><?php echo $row['email'];?></a></td> 
					<td><a  href="?action=edit&id=<?php echo $row['id'];?>"><?php echo $row['phone'];?></a></td> 
					<td><a  href="?action=edit&id=<?php echo $row['id'];?>"><?php echo $row['company'];?></a></td> 
					<td><a  href="?action=edit&id=<?php echo $row['id'];?>"><?php echo $row['Date'];?></a></td> 
					<td><a  href="?action=edit&id=<?php echo $row['id'];?>"><?php echo $row['Createdby'];?></a></td> 
					<td>
