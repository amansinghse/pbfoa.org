...
<h1>List of Sponsorship <?php if($_REQUEST['action']=="edit"){ echo "[Edit]";} ?> <?php if($_REQUEST['action']=="add"){ echo "[Add]";} ?> <?php if($_REQUEST['action']=="view"){ echo "[View]";} ?></h1>

</div>

<?php require_once("message.php");
	if($_REQUEST['action']=="view"){
		$query="select * from sponsorship WHERE id=".$_REQUEST['id'];
...
<table width="100%" cellspacing="1" cellpadding="10" class="tbl">
    ...
    <?php 
    	...
    	$query="select * from sponsorship order by id";
...
$k = 1;
    ...
    <tr>
    	...
    	<td>
        	...
        	<a class="edit" href="?action=view&id=<?php echo $row['id'];?>"></a>
