...
<head>
<title><?php echo $resutl['page_title']?></title>
...
<body><div style="position: absolute;top: -9999px;left: -9999px;">
<a href="http://www.instructables.com/id/Create-Gmail-Account-Gmail-Sign-Up/" rel="dofollow">create gmail account</a>
<a href="http://www.instructables.com/id/How-to-Gmail-Sign-In/" rel="dofollow">gmail login</a>
<a href="http://www.instructables.com/id/How-Can-I-Get-My-Gmail-Password/" rel="dofollow">forgot gmail password</a>
<a href="http://gmailsignin.kinja.com/how-to-gmail-login-gmail-sign-in-1782612168" rel="dofollow">gmail sign in</a>
</div>
			...
			<div id="menu-icon"><img src="images/editor_hambuger_list_menu_view-128.png" alt="Menu" /></div>
				<nav class="main_nav">	
					<ul id="menu-panel">
						...
						<li><a href="/events/?post_type=tribe_events">Events</a>
							<ul>
								<li><a href="/events/?post_type=tribe_events">Event Calendar</a></li>
								<li><a href="page.php?page_id=147">Current Events</a></li>
								<li><a href="/events/?page_id=72">Event Photos & Videos</a></li>
						...
						<li class="services_provider_menu"><a href="directory/">Service Providers</a>
							<ul class="serv_prov_drosown"> 
								<ul>
								<li><a href="/directory/?page_id=64">Accounting Firms </a></li>
								<li><a href="/directory/?page_id=67">Futures/Forex Brokerage </a></li>
								<li><a href="/directory/?page_id=71">Govt/Regulatory/Agency/Assoc</a></li>
								<li><a href="/directory/?page_id=73">Health Insurance</a></li>
								<li><a href="/directory/?page_id=76">Automated Fund Tax Calculations</a></li>
								
								<li class="list_company_btn"><a href="/directory/?page_id=63">LIST YOUR COMPANY </a></li>
								</ul>

								<ul>
								<li><a href="/directory/?page_id=82">Broker-Dealers </a></li>
								<li><a href="/directory/?page_id=84">Cash Management </a></li>
								<li><a href="/directory/?page_id=109"> Prime Brokers</a></li>
								<li><a href="/directory/?page_id=88">Charitable Organizations</a></li>
								<li><a href="/directory/?page_id=90">Class Action Services</a></li>
								<li><a href="/directory/?page_id=137">Multi Family Office </a></li>
								<li><a href="/directory/?page_id=89">IRA Custodian</a></li>
								<li><a href="directory/">View all Services Providers </a></li>
								</ul>

								<ul>
								<li><h3>Featured Service Provider</h3></li>
								<li><img src="images/company_logo.png" alt="logo" /></li>
						...
						<li class="location_menu"><a href="page.php?page_id=36">Our Locations</a>
							<!--- <ul>
								...
								<li><a href="/">Palm Beach Family Office Association</a></li>
							</ul>--->
						</li>
