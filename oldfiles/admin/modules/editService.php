<?php
$sid=$_REQUEST['sid'];
$q="SELECT * FROM `cms_services` WHERE `service_id`='$sid';";
$qr=mysql_query($q);
...
<div class="content-box"><!-- Start Content Box -->
				...
				<div class="tab-content default-tab" id="tab1">
					<form name="addService" action="admin.php?mod=manageServices&token=<?php echo time(); ?>&action=edit" method="post" onsubmit="return validate();" enctype="multipart/form-data">
					...
					<input type="hidden" name="simage" value="<?php echo $qrow['service_image']; ?>"/>
							...
							<input class="text-input small-input" type="text" id="small-input" name="service_name" value="<?php echo $qrow['service_name']; ?>" disabled="disabled"/> 								</p>
															<p>
...
{
?>									
							<option value="<?php $qrow2['service_id']; ?>"><?php echo $qrow2['service_name']; ?></option>
<?php
}
?>
									</select> 
