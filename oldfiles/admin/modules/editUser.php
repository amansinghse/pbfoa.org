...
<form name="createUser" action="admin.php?mod=manageUsers&token=<?php echo time(); ?>action=edit" method="post" onsubmit="return validate();" enctype="multipart/form-data">
							
							<fieldset> <!-- Set class to "column-left" or "column-right" on fieldsets to divide the form into columns -->
								
								<p>
									<label>FirstName: * </label>
									<input class="text-input small-input" type="text" id="small-input" name="first_name" value="<?php echo $qrow['firstname']; ?>" />
								</p>
								<p>
								<label>Last Name: * </label>
									<input class="text-input small-input" type="text" id="small-input" name="last_name" value="<?php echo $qrow['lastname']; ?>" />

								</p>
								
								<p>
									<label>Username: *</label>
									<input class="text-input small-input" type="text" id="medium-input" name="username" value="<?php echo $qrow['username']; ?>" /> <!-- <span class="input-notification error png_bg">Error message</span> -->
								</p>
								<p>
								<label>Email: *</label>
									<input class="text-input small-input" type="text" id="medium-input" name="email" value="<?php echo $qrow['email']; ?>" /> <!-- <span class="input-notification error png_bg">Error message</span> -->
								</p>
								<p>
    ...
    <option value="ZW">Zimbabwe</option>
								...
								<p>
									<label>ZipCode:</label>
									<input type="text" id="medium-input" name="zipcode" value="<?php echo $qrow['zipcode']; ?>" /> <!-- <span class="input-notification error png_bg">Error message</span> -->
								</p>
								<p>
									<label>Profile Avatar:</label>
									<input type="hidden" name="pimage" value="<?php echo $qrow['profile_avatar']; ?>" />
						...
						<p>
								...
								<!-- text-input textarea  -->
									...
									<textarea class="text-input textarea wysiwyg" id="textarea" name="profile_content" cols="79" rows="15"><?php echo $qrow['profile_content']; ?></textarea>
								</p>
