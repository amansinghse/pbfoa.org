...
<?php if($file_style == "block") { ?>
    <div class="fileDiv" style="display:none!important" onclick="window.location.href = 'http://imageuploaderforckeditor.altervista.org';">
...
<?php } elseif($file_style == "list") { ?>
    <div class="fullWidthFileDiv" style="display:none!important" onclick="window.location.href = 'http://imageuploaderforckeditor.altervista.org';">
