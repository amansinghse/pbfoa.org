...
$username = "asif"; $password = '995f039b6f964e7307630d1e8e9c38d2';

    $useruploadfolder = "test/images";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "test/images";
    ...
    $useruploadfolder = "dev/josh/images/";
    $useruploadpath = $usersiteroot."$useruploadfolder/";
    $foldershistory[] = "dev/josh/images/";
