<?php
$pagetitle_custom = "Basic Membership";
	include('header.php');
...
<section class="register_area">
		...
		<h1>About You (Contact Person)</h1>
			...
			<input type="text" name="addressa" required/>
			</label>
...
<option value="Zimbabwe">Zimbabwe</option>
			...
			<input type="text" name="companyemail" required/>
			</label>
			...
			<label class="full">Company Bio (* text only, no html codes) - limited to 250 characters. <span class="char_limit"></span><br />
			
			<textarea id="textarea" name="company_bio" placeholder="Company bio goes here..." maxlength="250" required></textarea>
			...
			<label class="full trem_area"><input type="checkbox" name="accterm" required/><span><strong>I accept the Terms & Conditions<sup>*</sup></span></strong></label>
...
$date = date("y-m-d");
 ...
 /*
					...
					*/  
					...
					$_SESSION['price']=995.00; 
					  
					  

					  $_SESSION['save_result'] = "INSERT INTO services_provider(fname,lname,job_title,company_name,category,phone,fax,address,addressb,city,state,zip,country,company_email,companyweb,tiwtter,facebook,linkedin,googleplus,company_bio,loginemail,password,opt,date,file,package_series) VALUES('$fname','$lname','$jobtitle','$cname','$categories','$phone','$fax','$addressa','$addressb','$city','$state','$zip','$country','$companyemail','$companyweb','$tiwtter','$facebook','$linkedin','$googleplus','$company_bio','$loginemail','$password','$opt','$date','$upload_pic','$package_series')";	
